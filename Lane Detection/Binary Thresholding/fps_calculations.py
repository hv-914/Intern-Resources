...
cap = cv2.VideoCapture(1)  # Change to 0 if using webcam
last_time = time.time()  # Initialize FPS timing
...
while cap.isOpened():
    ...
    cv2.putText(highlighted_frame, f"FPS: {int(fps)}", (10, 30), 
                cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2, cv2.LINE_AA)

    # Resize and show frames
