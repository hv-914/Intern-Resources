...
def main():
    ...
    while True:
        ...
        # Trapezoid
        roi_vertices = np.array([[  
            (width // 4, height // 2),  # Top-left (closer to center)
            (3 * width // 4, height // 2),  # Top-right (closer to center)
            (width, height),  # Bottom-right (full width)
        ...
        # Show frame
        cv2.imshow('Canny Edges', cv2.resize(edges, (720, 540)))
